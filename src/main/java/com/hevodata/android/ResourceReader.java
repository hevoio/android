...
/**
 * This class is for internal use in the Hevo library, and should not be imported into
 * client code.
 */
public abstract class ResourceReader implements ResourceIds {
    ...
    private static void readClassIds(Class<?> platformIdClass, String namespace, Map<String, Integer> namesToIds) {
        try {
            ...
            HLog.e(LOGTAG, "Can't read built-in id names from " + platformIdClass.getName(), e);
        }
    }
    ...
    protected void initialize() {
        ...
        try {
            ...
            HLog.w(LOGTAG, "Can't load names for Android view ids from '" + localClassName + "', ids by name will not be available in the events editor.");
            HLog.i(LOGTAG,
                    "You may be missing a Resources class for your package due to your proguard configuration, " +
                            ...
                            "you can add the following to your AndroidManifest.xml file to explicitly point the Hevo library to " +
                            "the appropriate library for your resources class:\n\n" +
                            "<meta-data android:name=\"com.hevodata.android.HevoConfig.ResourcePackageName\" android:value=\"YOUR_PACKAGE_NAME\" />\n\n" +
    ...
    private static final String LOGTAG = "HevoAPI.RsrcReader";
}
