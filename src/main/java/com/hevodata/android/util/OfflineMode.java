...
/**
 * Implement this to allow Hevo behave in-sync with your current custom offline logic
 */
public interface OfflineMode {

    /**
     * Returns true if offline-mode is active on the client. When true Hevo will not start
