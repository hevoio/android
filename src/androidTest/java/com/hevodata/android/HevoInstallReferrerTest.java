...
import com.hevodata.android.HevoConfig;
import com.hevodata.android.InstallReferrerReceiver;

public class HevoInstallReferrerTest extends AndroidTestCase {
    public void setUp() {
        mReceiver = new InstallReferrerReceiver();
        mIntent = new Intent();
        SharedPreferences prefs = getContext().getSharedPreferences(HevoConfig.REFERRER_PREFS_NAME, Context.MODE_PRIVATE);
    ...
    public void testNoReferrer() {
        ...
        SharedPreferences stored = getContext().getSharedPreferences(HevoConfig.REFERRER_PREFS_NAME, Context.MODE_PRIVATE);
