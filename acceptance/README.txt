...
2.  change mDecideEndpoint and mEditorUrl to your IP address with port 8000.
    eg. my IP is 172.16.20.43, so add
        <meta-data android:name="com.hevodata.android.HevoConfig.DecideEndpoint" android:value="http://172.16.20.43:8000" />
        <meta-data android:name="com.hevodata.android.HevoConfig.EditorUrl" android:value="http://172.16.20.43:8000" />
    to AndroidManifest.xml of hevo-android.
